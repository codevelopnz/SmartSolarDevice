...
* [2 x 120 ohm Resistors for the above LEDs](http://www.surplustronics.co.nz/products/1586-120-ohm-resistor-pk-10)
...
Optionally, If you want the whole unit self contained with only one mains power input (as apposed to one mains and one 5V DC @ 2amps input), you'll need:
...
* [3 x 10K ohm Resistors for the above Theristors](http://www.surplustronics.co.nz/products/1629-10k-ohm-resistor-pk-10)
